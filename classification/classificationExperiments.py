...
ConfusionMatrixDisplay.from_predictions(encoder.inverse_transform(y_test), encoder.inverse_transform(pred))

# X_train = X_train.reshape(X_train.shape[0], X_train.shape[1], 1)
# X_test = X_test.reshape(X_test.shape[0], X_test.shape[1], 1)
# modelName = "ResNet1D_2x2_moreFilters__onlyNorm_batch64"
# resnet: ResNet1D = ResNet1D(numFeatures, numClasses, n_blocks=2, n_layers=2, kSize=3)
# tensboard: TensorBoard = TensorBoard(log_dir=f"logs/{modelName}")
